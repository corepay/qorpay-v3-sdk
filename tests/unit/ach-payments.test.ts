...
describe('AchPayments', () => {
  ...
  describe('debit', () => {
    ...
    it('should return the debit response', async () => {
      ...
      const response = await achPayments.debit({
        transaction_data: sampleDebitData,
      });
    ...
    it('should handle API errors correctly', async () => {
      ...
      await expect(
        achPayments.debit({ transaction_data: sampleDebitData })
  ...
  describe('credit', () => {
    ...
    it('should return the credit response', async () => {
      ...
      const response = await achPayments.credit({
        transaction_data: sampleCreditData,
      });
    ...
    it('should handle API errors correctly', async () => {
      ...
      await expect(
        achPayments.credit({ transaction_data: sampleCreditData })
      ).rejects.toThrow(QorPayApiError);
      await expect(
        achPayments.credit({ transaction_data: sampleCreditData })
      ).rejects.toMatchObject({
  ...
  describe('void', () => {
    ...
    it('should return the void response', async () => {
      ...
      const response = await achPayments.void({
        transaction_data: sampleVoidData,
      });
    ...
    it('should handle API errors correctly', async () => {
      ...
      await expect(
        achPayments.void({ transaction_data: sampleVoidData })
      ).rejects.toThrow(QorPayApiError);
      await expect(
        achPayments.void({ transaction_data: sampleVoidData })
      ).rejects.toMatchObject({
  ...
  describe('refund', () => {
    ...
    it('should return the refund response', async () => {
      ...
      const response = await achPayments.refund({
        transaction_data: sampleRefundData,
      });
    ...
    it('should handle API errors correctly', async () => {
      ...
      await expect(
        achPayments.refund({ transaction_data: sampleRefundData })
      ).rejects.toThrow(QorPayApiError);
      await expect(
        achPayments.refund({ transaction_data: sampleRefundData })
      ).rejects.toMatchObject({
  ...
  describe('verify', () => {
    ...
    it('should return the verification response', async () => {
      ...
      const response = await achPayments.verify({
        transaction_data: sampleVerifyData,
      });
    ...
    it('should handle API errors correctly', async () => {
      ...
      await expect(
        achPayments.verify({ transaction_data: sampleVerifyData })
      ).rejects.toThrow(QorPayApiError);
      await expect(
        achPayments.verify({ transaction_data: sampleVerifyData })
      ).rejects.toMatchObject({
  ...
  describe('getTransaction', () => {
    it('should call the correct endpoint with transaction ID', async () => {
      mockBaseClient.get = jest
        .fn()
        .mockResolvedValue(sampleTransactionResponse);
    ...
    it('should handle API errors correctly', async () => {
      ...
      await expect(
        achPayments.getTransaction(sampleTransactionId)
      ).rejects.toThrow(QorPayApiError);
      await expect(
        achPayments.getTransaction(sampleTransactionId)
      ).rejects.toMatchObject({
