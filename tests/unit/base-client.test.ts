...
describe('BaseClient Integration', () => {
  ...
  describe('error handling', () => {
    ...
    it('should handle API errors with error status codes', async () => {
      await expect(client.get('/test-api-error')).rejects.toThrow(QorPayApiError);
    ...
    it('should handle API errors with success status codes but error status in body', async () => {
      await expect(client.get('/test-body-error')).rejects.toThrow(QorPayApiError);
    ...
    it('should handle server errors', async () => {
      await expect(client.get('/test-server-error')).rejects.toThrow(QorPayApiError);
    ...
    it('should handle network errors', async () => {
      ...
      await expect(timeoutClient.get('/test-network-error')).rejects.toThrow(QorPayNetworkError);
    });
